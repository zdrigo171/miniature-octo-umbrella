...
<br>
<H1><center>UOL</h1><h4>GSCentral</h4>
...
//}
                ...
                if (isset($_POST['btn-submit'])) {
                                ...
                                <br/>
                                <center>
                                <p style="background: #54bd0e; padding: 6px 20px; width: 180px; font-size: 13px; border-radius: 4px; color: #F0F0F0;"> Lista Carregada ('.$conta.') </p>
                                </center>
                                    <br/>
                                    <br/>
